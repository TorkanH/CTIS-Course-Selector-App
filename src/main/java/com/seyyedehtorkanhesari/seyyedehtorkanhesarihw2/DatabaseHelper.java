...
public class DatabaseHelper extends SQLiteOpenHelper {
    private static String DATABASE_NAME=" courseDB";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        try {
            sqLiteDatabase.execSQL(MediaTable.CREATE_TABLE_SQL);
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        ...
        try {
            sqLiteDatabase.execSQL(MediaTable.DROP_TABLE_SQL);
        }catch (SQLException e){
            e.printStackTrace();
        }
    ...
    public boolean insert(String tableName, ContentValues contentValues){
        ...
        //content for the table record in this column.
    ...
    public boolean update(String tableName, ContentValues contentValues, String
            whereCondition){
        //ContentValues allows to define key value pairs.
        //The key represents the table column identifier and the value represents the
        //content for the table record in this column.
